              ...
              Column(
                children: [
                  Padding(
                    ...
                    // child: Image.file(File('/storage/emulated/0/Android/data/com.abuzead.id_scanner/files/font-123.jpg')),
                        ...
                        RoundedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (LocationController.permission == LocationPermission.always ||
                                LocationController.permission == LocationPermission.whileInUse) {
